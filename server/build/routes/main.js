...
router.get('/', function (request, response) {
  ...
  response.send("".concat(__dirname, "/index.html"));
});
                    ...
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 5:
                        request.login(user, {
                          ...
                          response.cookie('refreshJwt', refreshToken); // Store Tokens in memeory.
...
router.route('/logout').get(processLogOutRequested).post(processLogOutRequested);
router.post('/token', function (request, response) {
  var refreshToken = request.body.refreshToken; // const refreshToken = response.body.refreshToken.
